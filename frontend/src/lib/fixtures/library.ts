...
const SHOWS: readonly MediaSummary[] = [
  ...
  { id: 161645, title: '药屋少女的呢喃', titleNative: '薬屋のひとりごと', year: 2023, season: '秋', episodes: 24, watched: 24, score: 87, genres: ['悬疑', '剧情', '历史'], description: '在花街长大的药师少女猫猫，被卖进后宫当下女。她凭着对毒与药的执念，一头撞进宫廷深处那些没人想说破的事。' },
  { id: 130003, title: '孤独摇滚！', titleNative: 'ぼっち・ざ・ろっく！', year: 2022, season: '秋', episodes: 12, watched: 12, score: 88, genres: ['音乐', '喜剧', '日常'], description: '一个连搭话都费劲的吉他少女，被硬拽进了乐队。社恐没治好，但台上那几分钟是真的。' },
  ...
  { id: 140960, title: '间谍过家家', titleNative: 'SPY×FAMILY', year: 2022, season: '春', episodes: 25, watched: 8, score: 86, genres: ['喜剧', '动作', '日常'], description: '为了任务，间谍临时组了个家：一个会读心的女儿，一个是杀手的妻子。三个人都在瞒着彼此，却意外地像一家人。' },
  ...
  { id: 104459, title: '摇曳露营△ 第二季', titleNative: 'ゆるキャン△ SEASON2', year: 2021, season: '冬', episodes: 13, watched: 0, score: 84, genres: ['日常', '治愈'], description: '几个女生在冬天的湖边扎营、煮东西、看星星。没有冲突，也不需要冲突。' },
  { id: 145545, title: '欢迎来到实力至上主义的教室 第二季', year: 2022, season: '夏', episodes: 13, watched: 3, score: 79, genres: ['心理', '剧情'], description: '一所把学生按「实力」分级的学校，规则写得漂亮，玩法全在字缝里。有人从一开始就在装弱。' },
  { id: 147864, title: '别当欧尼酱了！', titleNative: 'お兄ちゃんはおしまい！', year: 2023, season: '冬', episodes: 12, watched: 0, score: 76, genres: ['喜剧', '日常'], description: '闭门不出的哥哥一觉醒来变成了妹妹。身体换了，生活也被迫重新过一遍。' },
  { id: 153518, title: '迷宫饭', titleNative: 'ダンジョン飯', year: 2024, season: '冬', episodes: 24, watched: 18, score: 86, genres: ['奇幻', '冒险', '喜剧'], description: '妹妹被龙吃掉了，队伍散了，补给也没了。莱欧斯决定一边吃魔物一边往地牢深处走 —— 反正食材遍地都是。' },
...
].map((media) => ({ ...media, ...DEMO_ART[media.id] }))
...
export const FAKE_FEATURED: MediaSummary[] = SHOWS.filter((s) => s.banner !== undefined)
